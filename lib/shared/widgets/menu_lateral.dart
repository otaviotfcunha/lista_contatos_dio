...
import 'package:lista_contatos_dio/pages/perfil_page.dart';
import 'package:lista_contatos_dio/services/shared_preferences.dart';
          ...
          child: Column(              
            ...
            children: [
              ...
              UserAccountsDrawerHeader(
                ...
                accountName: Text(nomeUsuario, style: const TextStyle(color: Colors.blue, fontWeight: FontWeight.w900, fontSize: 20)),
                accountEmail: Text(emailUsuario, style: const TextStyle(color: Colors.blue, fontWeight: FontWeight.w900, fontSize: 16))
              ) 
              :
              UserAccountsDrawerHeader(
                decoration: BoxDecoration(
              ...
              const ItensMenuLateral(textMenu: "Seu perfil de usuário", paginaDireciona: PerfilPage(), iconeMenu: Icons.list),
              const Divider(),
              const SizedBox(
                height: 10,
              ),
